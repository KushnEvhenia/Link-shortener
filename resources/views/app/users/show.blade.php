        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <div class="mt-4 px-4">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.users.inputs.is_admin')
                        </h5>
                        <span>
                            @if($user->is_admin)
                                Yes
                ...
                <div class="mt-10">
                    ...
                    <a href="/users/list/{{$user->id}}" class="button">
                        List users links
                    </a>
                    <form action="{{ route('users.destroy', $user) }}" method="POST" onsubmit="return confirm('{{ __('crud.common.are_you_sure') }}')" style="margin-top:5px;">
                        @csrf @method('DELETE')
                        <button
                            type="submit"
                            class="button"
